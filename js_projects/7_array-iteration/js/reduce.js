// 5. Reduce
// Назначение Reduce:
// 1) служит для прохода по массиву с вычислением значения
...
// В роли аккумулятора, накапливающего значения выступает переменная sum
let sum = 0;
...
// Метод reduce
// В роли аккумулятора, накапливающего значения выступает параметр total
